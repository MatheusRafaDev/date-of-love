...
<body>
    <header>
        ...
        <div class="logo"><img src="/img - home/logoof.png"></div>
        <div class="container">
            <div class="menu">
                <nav>
            ...
            <div class="social">
                <button><i class="contato"></i>LOGIN</button>  </di>
            </a>
            </div>
            <div class="textoimagem">Criando memórias inesquecíveis </div>
    </header>
    ...
    <section id="sobre">
        <div class="container2"><img src="/img - home/casal2.png" alt="imagemcasal" class="casal2">
...
<div class="fundopretocominfo"><div class="infosfundo">
    <h2>Gastronomia</h2>
