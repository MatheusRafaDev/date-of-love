...
<body>
    ...
    <section id="base">
        <div class="container2">
            <img src="<%=request.getContextPath()%>/src/assets/images-home/casal2.png" alt="imagemcasal" class="casal2">
        </div>
    ...
    <div class="Estrutura">
        ...
        <div class="infosfundoimagem">
            <img src="<%=request.getContextPath()%>/src/assets/images-home/icones/logoGastro.png">
        </div>

        <div class="backpng">
            <img src="<%=request.getContextPath()%>/src/assets/images-home/icones/floresmetade.png">
        </div>

        <div class="fundopretocominfo2">
            <div class="Gastroimagens">
                <div class="pola1">
                    <img src="<%=request.getContextPath()%>/src/assets/images-home/ref1.png">
                </div>
                <div class="pola2">
                    <img src="<%=request.getContextPath()%>/src/assets/images-home/ref2.png">
                </div>
            </div>
            ...
            <div class="fimpagina">
                <div class="fimpag">
                    <div class="casalfim">
                        <img src="<%=request.getContextPath()%>/src/assets/images-home/FOTO COM QUADRO.png">
                    </div>
