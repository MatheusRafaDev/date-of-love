...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Exibição da imagem de pré-visualização após a seleção
        ...
        if (inputImage) {
            inputImage.addEventListener("change", function(event) {
                ...
                reader.onload = function(e) {
                    ...
                    previewImage.style.display = "block";  // Exibe a imagem de preview
                                ...
                                <div class="form-container2">
                                    <form action="${pageContext.request.contextPath}/mandar-imagem" method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="imagens-container">
                                           ...
                                           <input type="file" name="image" id="image" class="file-upload-buttom" accept="image/*" style="display: none;">
                                           <img id="previewImage" src="<%= finalImagePath2 %>" alt="Imagem do Casal" class="img-cabecalho" style="max-width: 200px; max-height: 200px; display: none;">
                                           <button type="submit" id="btnSalvar" class="btn-salvar2" disabled>Salvar</button>
                                       </div>
                                ...
                                <c:forEach var="orcamento" items="${listaOrcamentos}">
                                    <tr>
                                        <form action="${pageContext.request.contextPath}/visualizar-orcamento" method="GET">
                                            ...
                                            <td>R$ ${orcamento.getValorEstimado() == 0 ? '' : orcamento.getValorEstimado()}</td>
                                            <td>R$ ${orcamento.getValorTotal() == 0 ? '' : orcamento.getValorTotal()}</td>
